...
// The contract is located at ./testcontract/mockstorage.sol
// exec "solc --abi --bin -o build mockstorage.sol" and copy ABI and Bin from EthStorageContract.abi and EthStorageContract.bin
...
// exec "solc --abi --bin -o build BatchInbox.sol" and copy ABI and Bin from BatchInbox.abi and BatchInbox.bin
