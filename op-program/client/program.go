...
func Main(logger log.Logger) {
	...
	if err := RunProgram(logger, preimageOracle, preimageHinter); errors.Is(err, errors.New("invalid claim")) {
...
func RunProgram(logger log.Logger, preimageOracle io.ReadWriter, preimageHinter io.ReadWriter) error {
	...
	// pClient.Get(preimage.Keccak256Key{})
	...
	// l1PreimageOracle.HeaderByBlockHash(common.Hash{})
	// l2PreimageOracle.BlockByHash(common.Hash{})
