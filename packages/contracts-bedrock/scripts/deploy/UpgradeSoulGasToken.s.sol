...
contract UpgradeSoulGasToken is Script {
    ...
    function upgradeSoulGasTokenImpl(address _storageSetter) internal {
        ...
        IProxyAdmin proxyAdmin = IProxyAdmin(0x4200000000000000000000000000000000000018);
        address payable soulGasToken = payable(0x4200000000000000000000000000000000000800);
    ...
    function encodeSoulGasTokenInitializer() internal view virtual returns (bytes memory) {
        return abi.encodeCall(ISoulGasToken.initialize, ("SoulQKC", "SoulQKC", tx.origin));
    }
    ...
    function checkOutput() public view {
        ISoulGasToken soulGasToken = ISoulGasToken(0x4200000000000000000000000000000000000800);
